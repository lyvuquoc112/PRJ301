 ...
 */
@Entity
@Table(name = "Registration", catalog = "PRJSE1933", schema = "dbo")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Registration.findAll", query = "SELECT r FROM Registration r"), //static querry luôn nằm trong bộ nhớ. dược nạp vào bộ nhớ khi deploy
...
public class Registration implements Serializable {
    ...
    public String toString() {
        return "huylvq.persitence.Registration[ username=" + username + " ]";
    }
